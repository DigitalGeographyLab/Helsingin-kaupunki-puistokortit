# Helsingin viheralueita kuvaavat viheraluekortit

Tämä repositorio sisältää _Massadatoilla ymmärrystä Helsingin viheralueiden käytöstä_ -hankkeen (2025) tuloksena luodut viheraluekortit (puistokortit), niiden luomiseen käytetyt kuvaajat erillisinä kuvatiedostoina sekä interaktiivisen HTML-kartan. 
Lisätietoa korteista ja työstä [hankkeen loppuraportista](https://www.hel.fi/static/liitteet/kaupunkiymparisto/julkaisut/aineistot/aineistoja-21-25.pdf).
